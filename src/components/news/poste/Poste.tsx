  ...
  return (
    <>
          {isLoading ? ( 
            ...
            <>
            <section className="py-[40px] bg-white min-h-[85dvh] sm:py-[30px] sm:px-4 ">
              ...
              <div className="p-3  leading-10 block font-rb font-medium text-[20px] text-gray-800 sm:min-w-[80dvw] lg:max-w-[60dvw]">
                ...
                {poste?.images.map((image: { url: string; title: string }) => (
                  ...
                  >
                    <Image
                      ...
                      alt={poste?.title}
                      fill
                      className="object-center object-cover w-full h-full block rounded-md"
                    />
                  </div>
                ))}
              </div>
