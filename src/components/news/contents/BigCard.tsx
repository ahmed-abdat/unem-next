...
export default function BigCards({ card, index , router }: { card: NewsPoste; index: number , router: any}) {
  return  <div
...
>
  <div className="cursor-pointer rounded-sm h-[320px] sm:min-h-[350px] md:min-h-[400px] w-full  max-w-full relative">
    ...
    <div className="p-4">
      <h3
        className={'font-tajawal font-semibold text-[1.25rem] hover:underline'}
      >
        {card.title}
      </h3>
